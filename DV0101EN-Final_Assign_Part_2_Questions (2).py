...
app.layout = html.Div([
    ...
    html.H1("Automobile Sales Statistics Dashboard", style={'color': '#503D36', 'font-size': '24px', 'text-align': 'center'}),#May include style for title
    ...
    html.Div(id='output-container', className='output-container', style={'width': '80%', 'padding': '3px', 'font-size': '20px', 'text-align-last': 'center'}),])
])
...
#Plot 1 Automobile sales fluctuate over Recession Period (year wise)
        ...
        yearly_rec = recession_data.groupby('Year').agg({'Automobile_Sales': 'mean'}).reset_index()
        R_chart1 = dcc.Graph(
...
# TASK 2.6: Create and display graphs for Yearly Report Statistics
 # Yearly Statistic Report Plots                             
        ...
        # Handle the case when input_year is None
